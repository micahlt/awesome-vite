...
- [vite-vue3-simple-starter](https://github.com/micahlt/vite-vue3-simple-starter) - Minimal template with vanilla JS, Composition API, Vue Router, auto-import, navbar component, and lazy loaded routes
